...
java_prepare() {
	# Delete line 169, @override
	sed -i -e '169s/@Override//' \
		"${S}/org/glassfish/jersey/server/internal/inject/DelegatedInjectionValueFactoryProvider.java" \
		|| die "Could not remove overried"
}
