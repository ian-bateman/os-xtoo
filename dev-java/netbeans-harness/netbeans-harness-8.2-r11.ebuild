...
src_prepare() {
	...
	java-pkg_jar-from --into apisupport.harness/external javahelp javahelp.jar jsearch-2.0_05.jar
...
src_install() {
	...
	rm jsearch-2.0_05.jar && java-pkg_jar-from --into "${instdir}" javahelp javahelp.jar jsearch-2.0_05.jar
	popd >/dev/null || die
