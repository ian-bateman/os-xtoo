...
CP_DEPEND="
	~dev-java/jetty-alpn-client-${PV}:${SLOT}
	~dev-java/jetty-client-${PV}:${SLOT}
	~dev-java/jetty-http-${PV}:${SLOT}
	~dev-java/jetty-http2-client-${PV}:${SLOT}
	~dev-java/jetty-http2-common-${PV}:${SLOT}
...
DESCRIPTION="Jetty's Http2 Http Client Transport"
HOMEPAGE="https://www.eclipse.org/${MY_PN}/"
LICENSE="Apache-2.0"

S="${WORKDIR}/${MY_S}/${PN:0:11}/${PN#*-}"
